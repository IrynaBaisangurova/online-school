...
function handleCardClick(event) {
    const targetButton = event.target.closest('.card-add');
...
function checkingActiveButtons(basket) {
    const buttons = document.querySelectorAll('.card-add');
		...
		const cardItem = 
			`
                <div class="card" data-product-id="${id}">
                    <div class="card-top">
                        <a href="/card.html?id=${id}" class="card-image">
                            <img
                    ...
                    <div class="card-bottom">
                        <div class="card-prices">
                            ...
                            <div class="card-price card-price--common">${price}</div>
                        </div>
                        <a href="/src/card.html?id=${id}" class="card-title">${title}</a>
                        <button class="card-add">До кошика</button>
                    </div>
                </div>
            `
